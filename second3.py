...
KB.tell(logic.expr("At_2(Spare, Ground) | ~At_3(Spare, Ground) | Remove_2(Spare, Trunk)"))
...
KB.tell(logic.expr("At_2(Flat, Axle) | ~At_3(Flat, Axle)"))
KB.tell(logic.expr("At_2(Flat, Ground) | ~At_3(Flat, Ground) | Remove_2(Flat, Axle)"))
...
KB.tell(logic.expr("~At_2(Spare, Ground) | At_3(Spare, Ground) | PutOn_2(Spare, Axle)"))
KB.tell(logic.expr("~At_2(Spare, Trunk) | At_3(Spare, Trunk) | Remove_2(Spare, Trunk)"))
KB.tell(logic.expr("~At_2(Spare, Axle) | At_3(Spare, Axle)"))
KB.tell(logic.expr("~At_2(Flat, Axle) | At_3(Flat, Axle) | Remove_2(Flat, Axle)"))
KB.tell(logic.expr("~At_2(Flat, Ground) | At_3(Flat, Ground)"))
KB.tell(logic.expr("~At_2(Flat, Trunk) | At_3(Flat, Trunk)"))
...
KB.tell(logic.expr("Remove_0(Spare, Trunk) | Remove_0(Flat, Axle)"))
# for elem in actions:    
